...
$leFichier = file('derniersMessages.htm');             //On lit le fichier lastMessages.htm et on stocke la réponse dans une variable (de type tableau)
array_unshift($leFichier, $ligne);       //On ajoute le texte calculé dans la ligne précédente au début du tableau
file_put_contents('derniersMessages.htm', $leFichier); //On écrit le contenu du tableau $leFichier dans le fichier lastMessages.htm
?>
